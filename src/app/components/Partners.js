...
// Local fallback SVGs corresponding to the ones in PartnersStrip
...
const CATEGORIES = [
  ...
  { id: "retail", label: "Beauty & Retail" },
  { id: "convenience", label: "Convenience & Gas" },
];
...
const partners = [
  {
    ...
    ar: "عبد الله باوزير",
    Icon: Store,
    logoUrl: getFavicon("abawazir.net"),
    category: "retail",
  },
  {
    en: "Nice One",
    ...
    logoUrl: getFavicon("https://niceonesa.com/en"),
    category: "retail",
  },
  {
    en: "Whites Pharmacies",
    ar: "صيدليات وايتس",
    Icon: ActivityIcon,
    logoUrl: getFavicon("whites.net"),
    category: "pharmacy",
  },
  {
    en: "Nahdi Pharmacies",
    ar: "صيدليات النهدي",
    Icon: HeartPulseIcon,
    logoUrl: getFavicon("nahdionline.com"),
    category: "pharmacy",
  },
  {
    en: "Al Dawaa Pharmacies",
    ar: "صيدليات الدواء",
    Icon: PillIcon,
    logoUrl: getFavicon("https://www.al-dawaa.com/ar/"),
    category: "pharmacy",
  },
  {
    en: "Dar Al Amirat",
    ...
    logoUrl: getFavicon("https://daralamirat.com.sa/ar/"),
    category: "retail",
  },
  {
    en: "Makhazen Al Enaya",
    ar: "مخازن العناية",
    Icon: Store,
    logoUrl: getFavicon("makhazenalenaya.sa"),
    category: "retail",
  },
  {
    en: "Adam Pharmacies",
    ar: "صيدليات آدم",
    Icon: HeartPulseIcon,
    logoUrl: getFavicon("adamonline.com"),
    category: "pharmacy",
  },
  {
    en: "Ocean Pharmacies",
    ar: "صيدليات أوشن",
    Icon: PillIcon,
    logoUrl: getFavicon("oceanpharmacy.sa"),
    category: "pharmacy",
  },
  {
    en: "Vaneer Al Kharj",
    ar: "فانير الخرج",
    Icon: ShoppingBagIcon,
    logoUrl: getFavicon("vaneersa.com"),
    category: "retail",
  },
  {
    en: "Bahr Al Alamiah",
    ar: "بحر العالمية",
    Icon: Store,
    logoUrl: getFavicon("bader-intl.com"),
    category: "retail",
  },
  {
    en: "SASCO Stations",
    ar: "محطات ساسكو",
    Icon: FuelIcon,
    logoUrl: getFavicon("sasco.com.sa"),
  ...
  },
  {
    ...
    ar: "نجوم البتراء",
    Icon: MapPin,
    logoUrl: getFavicon("petrastars.com"),
    category: "pharmacy",
  },
  {
    en: "NMA Dammam",
    ar: "نما الدمام",
    Icon: Building2Icon,
    logoUrl: getFavicon("nmastores.com"),
    category: "retail",
  },
  {
    en: "Trolley",
    ...
    logoUrl: getFavicon("trolley.com.sa"),
    category: "convenience",
  },
  {
    en: "Outlet Stores",
  ...
  {
    en: "Orange Pharmacies",
    ar: "صيدليات اورانج",
    Icon: ActivityIcon,
    logoUrl: getFavicon("https://orangepharmacy.sa/"),
    category: "pharmacy",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-4 max-w-xl font-display text-4xl font-bold leading-[1.1] text-slate-900 sm:text-5xl">
              Trusted by Leading Retailers &amp; Pharmacies
            </h2>
          </div>
          ...
          <div className="relative w-full max-w-xs shrink-0">
            ...
            <input
              ...
              className="w-full rounded-full border border-slate-200 bg-white py-2.5 pl-10 pr-4 text-sm outline-hidden transition-colors duration-200 placeholder:text-slate-400 focus:border-primary focus:ring-1 focus:ring-primary"
            />
          </div>
        </div>
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
          {filteredPartners.map((p) => (
            ...
            >
              {/* Category indicator pill that fades in on hover */}
              <span className="absolute right-3 top-3 scale-90 rounded-full bg-slate-50 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-slate-400 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                {p.category === 'convenience' ? 'Gas & Shop' : p.category === 'pharmacy' ? 'Pharmacy' : 'Retail'}
              </span>
          ...
          {filteredPartners.length === 0 && (
            <div className="col-span-full py-16 text-center">
              ...
              <p className="mt-4 text-sm font-semibold text-slate-900">No partners found</p>
